...
//
// fbx.mjs 는 일부러 지오메트리만 읽는다(그 파일 상단 주석 참고) - 스프라이트로 구울 땐
// 그걸로 충분했다. 이제 잠수부의 Idle 애니메이션을 구우려면 뼈대, 스킨 웨이트, 바인드
// 행렬, 애니메이션 커브가 다 필요하다. fbx.mjs 를 고치는 대신 이 파일을 새로 만든 이유는
// tools/bake-diver-3d.mjs 가 fbx.mjs 에 그대로 의존하고 있어서다 - 이 파일이 커져도
// 그쪽은 전혀 영향받지 않는다.
//
