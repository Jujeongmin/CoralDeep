...
const KO: Dict = {
  ...
  adNotReady: '광고 준비 중이에요. 잠시 뒤에 다시 시도해 주세요',
...
const EN: Dict = {
  ...
  adNotReady: 'No ads to show yet — please try again shortly',
...
const JA: Dict = {
  ...
  adNotReady: '広告を準備中です。少し経ってからもう一度お試しください',
